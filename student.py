...
class Student:
    def __init__(self,root):
        ...
        #image 1
        img=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\s1.jpg")
        ...
        #image 2
        img1=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\s3.webp")
        ...
        #image 3
        img2=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\s2.jpg")
        ...
        #background image 
        img3=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\bg_img.jpg")
        ...
        main_frame.place(x=22,y=50,width=1480,height=600)
        ...
        #image_left 
        img_left=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\left_frame.jpg")
        ...
        dept_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",12,"bold"),width=20,state="read only")
        ...
        course_combo["values"]=("Select Courses","CF","AIML","STA","DMVL")
        ...
        delete_btn=Button(btn_frame,text="Delete",command=self.Delete,width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        right_frame.place(x=750,y=10,width=730,height=580)
         ...
         #image_right
        img_right=Image.open(r"C:\Users\sejal\OneDrive\Desktop\face_recognition_system\images\right_frame.jpg")
...
# function declaration
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="sejal2021",database="face_recognizer")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update > 0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="sejal2021",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,Course=%s,Year=%s,Semester=%s,Name=%s,Email=%s,Division=%s,RollNo=%s,Gender=%s,Dob=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def reset_data(self):
        ...
        self.var_roll.set(""),
        self.var_gender.set("Select Gnder"),
        self.var_dob.set(""),
        self.var_email.set("")
        self.var_phone.set(""),
       ...
       #*******************************generate datset or take photo sample******************8
